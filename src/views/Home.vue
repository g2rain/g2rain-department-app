    ...
    <el-card class="home-card">
      <template #header>
        <div class="card-header">
          <h2>{{ $t('DE_HOME_WELCOME', '欢迎使用部门与数据权限管理') }}</h2>
      ...
      <div v-else class="empty-routes">
        <el-empty :description="$t('DE_HOME_NO_ENTRY', '暂无可用功能入口')" :image-size="100" />
      </div>
    </el-card>
  </div>
</template>
