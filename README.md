...
`g2rain-department-app` ? G2rain ??????????????????????????????????????????????????????????????????????????????????????????

## 3. ????

? G2rain???? AI ???? SaaS ???????`g2rain-department-app` ????????????????????????????????
...
?? `g2rain-department`?`g2rain-main-shell`?`g2rain-basis`?`g2rain-iam` ?????
...
- ???????????????????????????????????????????????????????????????????
- ???????????????????????SSO ????????????? `/keys/iam-key-id`?`/keys/iam-public-key`?`/lua/sign_code` ? OpenResty Lua ?????????????????
- ????????????????????????????????????? `build:generate` ????????? `build:config` ?????????
...
- `auth`?????????????
- `department`???????????? `index.vue`?`api.ts`?`type.ts`?
...
- ??? qiankun ????`adapter.qiankun.ts` ????????????????????

#### 2. ???????????

- ????????? boot ???
- ???? `VITE_APPLICATION_CODE` ??????????????????? API ???
...
- ??????????????? SSO ???????????
- ??????????????????????
- ???????????????? `/keys/iam-key-id`?`/keys/iam-public-key` ?? IAM ??????? `/lua/sign_code` ???????
- ????? OpenResty + Lua ????????????????
...
- `lua/sign.lua`?`lua/sign_api.lua` ??????? IAM ???????
